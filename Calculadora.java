...
/**
 * @param 
 * inicialitzaci� de les variables de la calculadora
 */
 ...
 * 
 * @return int 
 * Retorna el valor del camp text_resultat com un valor num�ric 
 */
...
return Integer.parseInt(resultat);
  ...
  * 
  * @param int digit
  * Afegix un nou d�git al camp text_resultant
  */
...
inicialitza_resultat = false;
 ...
 /**
  * 
  * @param java.lang.String new_operacio
  * �nicament en el casde poder executar l'operaci�, s'han assignat els dos operands �s quan el sistema realitza 
  * la crida d'execuci�
  */
...
operacio = new_operacio;
 ...
 /**
  * @param 
  * Al finalitzar el calcul s'executa la darrera operaci� especificada i es visualitza el resultat
  */
...
operacio = "null";
  ...
  * 
  * @return int
  * Execuci� de la operaci� que pot ser suma, resta,divisi�, multiplicaci�.
  */
 ...
 * 
 * @param args
 * Inici en l'execuci� de la calculadora 
 */
